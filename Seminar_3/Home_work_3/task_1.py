"""Этот код для игры в "Крестики-нолики" использует процедурный стиль программирования,
организуя код вокруг функций, каждая из которых выполняет определенную задачу, такую как проверка победы,
отображение игровой доски и управление процессом игры.
    Однако в коде также присутствуют элементы императивного программирования.
Этот стиль сфокусирован на последовательных командах, изменении состояния программы через инструкции и манипуляции
с данными. В коде есть циклы, условные операторы (while, if), изменение состояния игрового поля и прямые вызовы
функций для управления процессом игры и проверки победы.
"""
